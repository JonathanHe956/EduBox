            ...
            <ul class="mt-4 space-y-3">
                @foreach($examenes as $examen)
                    ...
                    <li class="border rounded p-3 flex justify-between items-center">
                        <div>
                            <a class="font-medium text-lg" href="{{ route('exams.show', $examen) }}">{{ $examen->titulo }}</a>
                        ...
                        <div>
                            ...
                            @else
                                <a href="{{ route('exams.show', $examen) }}" class="bg-green-600 text-white px-3 py-1 rounded hover:bg-green-700">Realizar</a>
                            @endif
                        </div>
                    </li>
                @endforeach
