            ...
            <form action="{{ route('carrera.update', $carrera) }}" method="post" class="space-y-6">
                ...
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div>
                        ...
                        <input type="text" name="nombre" id="nombre" value="{{ old('nombre', $carrera->nombre) }}" class="mt-1 block w-full rounded-md border border-blue-200 px-3 py-2 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500 dark:border-blue-800 dark:bg-zinc-800 dark:text-white" required oninput="validarTexto(this)">
                        @error('nombre')
