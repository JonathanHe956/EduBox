<x-layouts.app :title="_('Administracion de Carreras')">
    ...
    <div class="flex h-full w-full flex-1 flex-col gap-6 p-6">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('carrera.create') }}" class="inline-flex items-center rounded-md bg-blue-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
                Crear Carrera
            </a>
        </div>
        ...
        <div class="rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-zinc-900">
            <form action="{{ route('carrera.buscar') }}" method="post" class="flex gap-4">
                @csrf
                <input type="text" name="Buscar_carrera" placeholder="Buscar carrera..." class="flex-1 rounded-md border border-gray-300 px-3 py-2 focus:border-blue-500 focus:outline-none focus:ring-blue-500 dark:border-gray-600 dark:bg-zinc-800 dark:text-white"/>
                        ...
                        <tr class="border-b border-blue-200/50 dark:border-blue-700/50 hover:bg-blue-50/50 dark:hover:bg-blue-900/30 transition-colors duration-150">
                            ...
                            <td class="px-6 py-4">
                                <div class="flex gap-2">
                                    <a href="{{ route('carrera.show', $carrera) }}" class="rounded-md bg-blue-500 px-3 py-1 text-sm text-white hover:bg-blue-600">Ver</a>
                                    <a href="{{ route('carrera.edit', $carrera) }}" class="rounded-md bg-gray-500 px-3 py-1 text-sm text-white hover:bg-gray-600">Editar</a>
