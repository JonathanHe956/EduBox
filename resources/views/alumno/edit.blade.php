<x-layouts.app :title="_('Editar Alumno')">
    <div class="flex h-full w-full flex-1 flex-col gap-6 p-6">
        ...
        <div class="glass-card p-6 max-w-4xl mx-auto w-full">
            ...
            <form action="{{ route('alumno.update', $alumno) }}" method="post" enctype="multipart/form-data" class="space-y-6" onsubmit="return validarFormulario()">
                @csrf
                @method('PUT')
                                ...
                                <div class="flex">
                                    ...
                                    <div class="ml-3">
                                        <p class="text-sm text-yellow-700 dark:text-yellow-200">
                                            No se puede cambiar la carrera porque el alumno tiene materias inscritas.
                                        </p>
                                    </div>
                                </div>
                            </div>
