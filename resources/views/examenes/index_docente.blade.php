    ...
    <div class="flex h-full w-full flex-1 flex-col gap-6 p-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-blue-700 dark:text-blue-200">Listado general de todos tus exámenes creados.</p>
            </div>
            {{-- Sin botón de crear aquí, ya que se crea dentro de una materia específica normalmente --}}
        </div>
        ...
        <div class="glass-card">
            @if($examenes->isEmpty())
                <div class="flex flex-col items-center justify-center py-12 text-center">
                    ...
                    <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Tus exámenes creados aparecerán aquí.</p>
                </div>
            @else
