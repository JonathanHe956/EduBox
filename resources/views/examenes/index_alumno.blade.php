<x-layouts.app :title="__('Mis Exámenes')">
    <div class="flex h-full w-full flex-1 flex-col gap-6 p-8">
        ...
        {{-- Encabezado --}}
        <div>
            <h1 class="text-2xl font-bold text-blue-900 dark:text-white">Todos los Exámenes Pendientes</h1>
            <p class="mt-1 text-blue-700 dark:text-blue-200">Lista general de exámenes pendientes de todas tus materias.</p>
        </div>
