                        ...
                        @foreach($examenes as $ex)
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-zinc-800/50">
                                ...
                                <td class="whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                                    @if($hasAttempt)
                                        <a href="{{ route('examenes.result', $intento) }}" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300">
                                            Ver resultado
                                        </a>
                                    @else
                                        <a href="{{ route('examenes.show', $ex) }}" class="text-green-600 hover:text-green-900 dark:text-green-400 dark:hover:text-green-300">
                                            Realizar examen
                                        </a>
                                    @endif
                                </td>
