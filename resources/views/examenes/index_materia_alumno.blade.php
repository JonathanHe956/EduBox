    ...
    <div class="flex h-full w-full flex-1 flex-col gap-6 p-6">
        ...
        <div class="flex items-center justify-between">
            <div>
                ...
                <p class="mt-1 text-blue-700 dark:text-blue-200">Completa los exámenes disponibles para esta materia.</p>
            </div>
        </div>
                                ...
                                <tr class="border-b border-blue-200/50 dark:border-blue-700/50 hover:bg-blue-50/50 dark:hover:bg-blue-900/30 transition-colors duration-150">
                                    ...
                                    <td class="px-6 py-4">
                                        <div class="flex items-center justify-end gap-2">
                                            ...
                                            @else
                                                <a href="{{ route('examenes.show', $ex) }}" class="inline-flex items-center gap-1 rounded-lg bg-green-600 px-3 py-1 text-xs font-medium text-white hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500">
                                                    Realizar Examen
                                                </a>
                                            @endif
                                        </div>
