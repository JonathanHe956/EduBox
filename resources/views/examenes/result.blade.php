<x-layouts.app :title="__('Resultado del Examen')">
    <div class="px-4 py-6 max-w-4xl mx-auto">
        ...
        <div class="mt-8 flex justify-center">
            <a href="{{ route('examenes.materia.alumno', $intento->examen->materia_id) }}" class="inline-flex items-center gap-2 rounded-lg bg-indigo-600 px-6 py-3 text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">
