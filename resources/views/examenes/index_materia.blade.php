<x-layouts.app :title="__('Exámenes de ' . $materia->nombre)">
    <div class="px-4 py-6">
        <div class="flex items-center justify-between mb-6">
            ...
            <a href="{{ route('examenes.create', $materia) }}" class="inline-flex items-center gap-2 rounded-lg bg-indigo-600 px-4 py-2 text-sm font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 dark:focus:ring-offset-zinc-900">
                            ...
                            <tr class="hover:bg-gray-50 dark:hover:bg-zinc-800/50">
                                ...
                                <td class="whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                                    <div class="flex items-center justify-end gap-3">
                                        <a href="{{ route('examenes.show', $ex) }}" class="text-indigo-600 hover:text-indigo-900 dark:text-indigo-400 dark:hover:text-indigo-300">Ver</a>
                                        <a href="{{ route('examenes.edit', $ex) }}" class="text-yellow-600 hover:text-yellow-900 dark:text-yellow-400 dark:hover:text-yellow-300">Editar</a>
