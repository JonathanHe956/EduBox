<x-layouts.app :title="__('Detalle del Alumno')">
    <div class="flex h-full w-full flex-1 flex-col gap-6 p-6">
        ...
        <div class="mt-4">
            @if($materia)
                <a href="{{ route('docente.alumnos.materia', $materia) }}" class="inline-flex items-center gap-2 text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300">
